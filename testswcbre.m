function test=testswcbre(y,x,nc,link1,link2,family1,family2,beta1,beta2,N1,N2,alpha)

%Schennach-Wilhelm (2017) test for the CBRE estimator
%
%Input:
%
...
[~,z01]=bc_cbre_ll(y,x,nc,beta1,link1,family1,N1,N2);
[~,z02]=bc_cbre_ll(y,x,nc,beta2,link2,family2,N1,N2);
