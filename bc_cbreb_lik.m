function [ll,gb,Hb,ga,Ha,H]=bc_cbreb_lik(y,x,nc,b,a,link,N1,d)
...
H=(A(2:end,2:end)+A(1:end-1,1:end-1)-A(2:end,1:end-1)-A(1:end-1,2:end))*d^2;%beta parameters as in Sancetta, Satchell
binoms=zeros(1,d);
for i1=0:1:d-1
...
for i0=1:1:length(a)
    ...
    A(:,end)=A(end,:)';
    A(2:end-1,2:end-1)=reshape(a,d-1,d-1);
    H=(A(2:end,2:end)+A(1:end-1,1:end-1)-A(2:end,1:end-1)-A(1:end-1,2:end))*d^2;
    binoms=zeros(1,d);
    for i1=0:1:d-1
        binoms(i1+1)=nchoosek(d-1,i1);
    end
